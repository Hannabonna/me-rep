				...
				<div class="page-content">
					...
					<div class="row-fluid">
						<div class="span12">
							<!--PAGE CONTENT BEGINS-->
							 <?php
								$data=mysql_query("SELECT * FROM infopar WHERE kota LIKE '".mysql_real_escape_string($kota)."'");
								while ($row=mysql_fetch_array($data))
								{ 
							?>
							<form method="post" action="cek-editinfo.php" class="form-horizontal">
								<div class="control-group">
									<label for="kota" class="control-label">Kota</label>
									<div class="controls">
										<input type="text" class="span6" value="<?php echo $row['kota'];?>" name="kota">
									</div>
								</div>
								<div class="control-group">
									<label for="namatempat" class="control-label">Nama Tempat</label>
									<div class="controls">
										<input type="text" class="span6" name="namatempat" value="<?php echo $row['namatempat'];?>">
									</div>
								</div>
								<div class="control-group">
