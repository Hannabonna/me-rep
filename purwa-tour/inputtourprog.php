			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Input Itinerary Perjalanan</li>
					</ul><!--.breadcrumb-->
				...
				<div class="page-content">
					...
					<div class="row-fluid">
						<div class="span12">
							<!--PAGE CONTENT BEGINS-->
							<form method="post" action="cek-tourprog.php" class="form-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span6" name="tujuan" id="tujuan" value="Tujuan Wisata" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Tujuan Wisata';}">
									</div>
								</div>
								<div class="control-group">
									<label for="gambar" class="control-label">File input</label>
									<div class="controls"><input type="file" name="gambar" id="gambar">
										<p class="help-block">Upload gambar dalam bentuk jpg.</p>
									</div>
								</div>
								<div class="control-group">
									<label for="deskripsi" class="control-label">Rincian Perjalanan</label>
									<div class="controls"><textarea name="deskripsi" id="deskripsi" value="Rincian Perjalanan" cols="50" rows="6" class="span6"></textarea></div>
								</div>
