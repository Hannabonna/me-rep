			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Data Info Pariwisata</li>
					</ul><!--.breadcrumb-->
										...
										<tr class="odd gradeX">
											...
											<td class="td-actions">
												<div class="hidden-phone visible-desktop action-buttons">
													<a class="green"  href="edit-infopar.php?kota=<?php echo $data['kota']; ?>">
														<i class="icon-zoom-in bigger-130"></i>
													</a>

													<a class="red" href="hapus-info.php?kota=<?php echo $data['kota'];?>"  onclick ="return confirm('Apakah Anda Yakin?');">
												...
												<div class="hidden-desktop visible-phone">
													<div class="inline position-relative">
														...
														<ul class="dropdown-menu dropdown-icon-only dropdown-yellow pull-right dropdown-caret dropdown-close">
															<li>
																<a href="edit-infopar.php?kota=<?php echo $data['kota']; ?>" class="tooltip-info" data-rel="tooltip" title="Edit">
																	<span class="blue">
															...
															<li>
																<a href="hapus-info.php?kota=<?php echo $data['kota']; ?>"  class="tooltip-error" data-rel="tooltip" title="Delete">
																	<span class="red">
