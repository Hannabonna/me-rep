				...
				<div class="page-content">
					...
					<div class="row-fluid">
						<div class="span12">
							<!--PAGE CONTENT BEGINS-->
							 <?php
								$data=mysql_query("SELECT * FROM itinerary WHERE kodepaket LIKE '".mysql_real_escape_string($kodepaket)."'");
							...
							<form method="post" action="cek-tourprog.php" class="form-horizontal">
								...
								<div class="control-group">
									...
									<div class="controls">
										<input type="text" class="span6" name="tujuan" value="<?php echo $row['tujuan'];?>">
									</div>
								</div>
								<div class="control-group">
								...
								<div class="control-group">
									...
									<div class="controls"><textarea name="deskripsi" value="" cols="50" rows="6" class="span6"> <?php echo $row['deskripsi'];?> </textarea></div>
								</div>
