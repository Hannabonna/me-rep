			...
			<div class="main-content">
				<div class="breadcrumbs" id="breadcrumbs">
					<ul class="breadcrumb">
						...
						<li class="active">Input Info Pariwisata</li>
					</ul><!--.breadcrumb-->
				...
				<div class="page-content">
					<div class="page-header position-relative">
						<h1>
							Input Info Pariwisata
							<small>
								<i class="icon-double-angle-right"></i>
								Seputar Tempat Wisata
							</small>
						</h1>
					</div><!--/.page-header-->
					...
					<div class="row-fluid">
						<div class="span12">
							<!--PAGE CONTENT BEGINS-->
							<form method="post" action="cek-infopar.php" class="form-horizontal">
								<div class="control-group">
									<label for="kota" class="control-label">Kota</label>
									<div class="controls">
										<input type="text" class="span6" value="Kota" name="kota" id="kota" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Kota';}">
									</div>
								</div>
								<div class="control-group">
									<label for="namatempat" class="control-label">Nama Tempat</label>
									<div class="controls">
										<input type="text" class="span6" name="namatempat" id="namatempat" value="Nama Tempat" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Nama Tempat';}">
									</div>
								</div>
								<div class="control-group">
