							...
							<tbody>
									<?php 
										...
										<tr class="odd gradeX">
											...
											<td><a href="<?php echo "../images/foto/".$data['gambar']."";?>" target="_blank"> <?php echo "<img src='../images/foto".$data['gambar']."' width=150 height=125>";?></td>
											<td><?php echo $data['keterangan'];?></td>
											
											<td class="td-actions">
												<div class="hidden-phone visible-desktop action-buttons">
													<a class="green"  href="edit-paket.php?kodepaket=<?php echo $data['kodepaket']; ?>">
														<i class="icon-zoom-in bigger-130"></i>
													</a>

													<a class="red" a href="hapus-paket.php?kodepaket=<?php echo $data['kodepaket']; ?>" onclick ="return confirm('Apakah Anda Yakin?');">
												...
												<div class="hidden-desktop visible-phone">
													<div class="inline position-relative">
														...
														<ul class="dropdown-menu dropdown-icon-only dropdown-yellow pull-right dropdown-caret dropdown-close">
															<li>
																<a href="edit-paket.php?kodepaket=<?php echo $data['kodepaket']; ?>" class="tooltip-info" data-rel="tooltip" title="Edit">
																	<span class="blue">
															...
															<li>
																<a href="hapus-paket.php?kodepaket=<?php echo $data['kodepaket']; ?>" class="tooltip-error" data-rel="tooltip" title="Delete">
																	<span class="red">
