		...
		<div class="row">
			...
			<article class="col-md-8 maincontent">
				<header class="page-header">
					<h1 class="page-title">Detail Project</h1>
				</header>
				...
				<header>
					<h2>Melihat Dokumen Project Secara Keseluruhan</h2>
				</header>
				...
				<label for="nprj">No. Project :</label>
					<select name="nprj" class="form-control" id="p">
			    ...
			    <p>
				<div class="form-group">
				<label for="norft">No.RFT  :</label>
					<select name="norft" class ="form-control">
						<option value="">pilih</option>
					</select>
				</div>
				</p>
				<a><input type="submit" class="btn btn-info" value="CLOSE" /></a>
				<a><input type="submit" class="btn btn-info" value="SUBMIT" /></a>
				<br>
				<br>
				<p><a><input type="submit" class="btn btn-warning" value="EXIT" /></a></p>
				</article>
				</center>
				</div>
				</div>
